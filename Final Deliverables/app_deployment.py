...
if authentication_status:
    ...
    if st.sidebar.checkbox('View Prediction Model'):
        ...
        def pred(gre, toefl, univ_rank, sop, lor, cgpa):
            ...
            #prediction = model.predict([[gre, toefl, univ_rank, sop, lor, cgpa ]])
            
            payload_scoring = {"input_data": [{"field": [["GRE Score","TOEFL Score","University Rating","SOP","LOR ","CGPA"]], "values": [[gre, toefl, univ_rank, sop, lor, cgpa]]}]}
            ...
            st.info("Chance of Admittance for University Rank " + str(univ_rank) + " = " + str(round(probability[0]*100))+" %")
            
            
            if probability[0] >= 0.6667:
                st.success(
        ...
        def main():
            ...
            if st.button("Predict"):
                pred(gre, toefl, univ_rank, sop, lor, cgpa)
